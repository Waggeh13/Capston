...
<body>
        ...
        <div class="header">
            <div class="header-left">
                <div class="username-section">
                    ...
                    <span id="username"><?php echo htmlspecialchars($userProfile->getUserName()); ?></span>
                </div>
            </div>
            ...
            if (!empty($pending_payments)) {
                foreach ($pending_payments as $payment) {
                    ...
                    <div class="payment-card" 
                         data-dispensed-ids='<?php echo json_encode($payment['dispensed_ids']); ?>' 
                        ...
                        <div class="patient-info">
                            <div class="patient-photo"><?php echo htmlspecialchars($initials); ?></div>
                            <div>
                            ...
                            if (!empty($payment['consultations'])) {
                                foreach ($payment['consultations'] as $consult) {
                                    ...
                                    <div class="service-item">
                                        ...
                                        <input type="number" class="price-input" value="500.00" min="0" step="0.01" data-type="consultation" data-id="<?php echo htmlspecialchars($consult['booking_id']); ?>">
                                    </div>
                                    <?php
                                }
                            } else {
                        ...
                        <div class="service-section">
                            ...
                            if (!empty($payment['medications'])) {
                                foreach ($payment['medications'] as $med) {
                                    ?>
                                    <div class="service-item">
                                        <span><?php echo htmlspecialchars($med['medication'] . ' ' . $med['dosage'] . ' (Qty: ' . $med['quantity_dispensed'] . ')'); ?></span>
                                        <input type="number" class="price-input" value="0.00" min="0" step="0.01" data-type="medication" data-id="<?php echo htmlspecialchars($med['medication_id']); ?>">
                                    </div>
                                    <?php
                                }
                            } else {
                                ?>
                                <div class="service-item">
                                    <span>No prescriptions recorded</span>
                                    <input type="number" class="price-input" value="0.00" min="0" step="0.01" data-type="medication" data-id="0" disabled>
                                </div>
                                <?php
                            }
                            ?>
                            ...
                            if (!empty($payment['lab_tests'])) {
                                foreach ($payment['lab_tests'] as $test) {
                                    ...
                                    <div class="service-item">
                                        ...
                                        <input type="number" class="price-input" value="0.00" min="0" step="0.01" data-type="lab_test" data-id="<?php echo htmlspecialchars($test['lab_test_id']); ?>">
                                    </div>
                                    <?php
                                }
                            } else {
                        ...
                        <div class="payment-actions">
                            <button class="btn btn-secondary" onclick="viewDetails('<?php echo htmlspecialchars($patient['patient_id']); ?>', '<?php echo htmlspecialchars($payment['prescription_id']); ?>')">
            ...
            if (!empty($recent_payments)) {
                foreach ($recent_payments as $payment) {
                    ...
                    <div class="payment-card">
                        ...
                        <div class="payment-actions">
                            <button class="btn btn-secondary" onclick="viewReceipt('<?php echo htmlspecialchars($payment['receipt_id']); ?>')">
    ...
    <div class="modal" id="detailsModal">
        <div class="modal-content">
            ...
            <div class="patient-info" style="margin-bottom: 20px;" id="detailPatientInfo"></div>
            
            <div id="consultationDetails" style="margin-bottom: 25px;"></div>
            
            <div id="prescriptionDetails" style="margin-bottom: 25px;"></div>
            
            <div id="labTestDetails" style="margin-bottom: 25px;"></div>
