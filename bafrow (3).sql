...
--
-- Host: localhost:3306
-- Generation Time: Apr 27, 2025 at 11:35 PM
...
CREATE TABLE `request_table` (
  ...
  `hospital_name` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
...
--
ALTER TABLE `request_table`
  ADD CONSTRAINT `request_table_ibfk_1` FOREIGN KEY (`patient_id`) REFERENCES `user_table` (`user_id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `request_table_ibfk_2` FOREIGN KEY (`doctor_id`) REFERENCES `user_table` (`user_id`) ON DELETE CASCADE ON UPDATE CASCADE;
